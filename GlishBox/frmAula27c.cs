...
namespace GlishBox
{
    public partial class frmAula27c : Form
    {
        ...
        {
            frmAula27 objaula27 = new frmAula27();
            objaula27.ShowDialog();
            this.Close();
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            synthbr.SpeakAsync("Na forma interrogativa do Future Perfect o auxiliar modal will se posicina antes do sujeito.");
            synthen.Rate = -5;
        }
    }
}
